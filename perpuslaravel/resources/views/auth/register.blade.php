...
@section('isi')
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('{{ asset('/') }}assets/img/slide3.jpg');">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Selamat datang di perpustakaan kami! Kami berharap Anda menemukan
                            pengalaman yang bermanfaat dan memuaskan di sini..</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('register.action') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label>alamat</label>
                                    <input class="form-control" type="alamat" name="alamat" value="{{ old('alamat') }}" />
                                </div>
                                <div class="mb-3">
